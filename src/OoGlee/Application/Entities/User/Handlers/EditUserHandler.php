...
use Ooglee\Domain\Entities\Post\Validators\PostValidator;
use Ooglee\Domain\Contracts\IHashingService;
use Ooglee\Domain\CommandBus\ICommand;

class EditPostHandler implements IHandler {
    ...
    public function __construct(PostValidator $validator, IPostRepository $repository, Dispatcher $dispatcher)
    {
